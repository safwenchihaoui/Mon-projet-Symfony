 ...
 */
final class Version20250116080117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP nom, DROP prenom, DROP description, CHANGE email email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(50) NOT NULL, ADD prenom VARCHAR(50) NOT NULL, ADD description VARCHAR(50) NOT NULL, DROP roles, DROP password, CHANGE email email VARCHAR(150) NOT NULL');
    }
}
